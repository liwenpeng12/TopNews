...
/** 
 * DAO for table "SOCIAL_BEAN".
*/
public class SocialBeanDao extends AbstractDao<SocialBean, Long> {

    public static final String TABLENAME = "SOCIAL_BEAN";

    /**
     * Properties of entity SocialBean.<br/>
    ...
    public SocialBeanDao(DaoConfig config) {
        super(config);
    }
    
    public SocialBeanDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"SOCIAL_BEAN\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"SOCIAL_BEAN\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, SocialBean entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, SocialBean entity) {
        stmt.clearBindings();
    ...
    @Override
    public SocialBean readEntity(Cursor cursor, int offset) {
        SocialBean entity = new SocialBean( //
    ...
    @Override
    public void readEntity(Cursor cursor, SocialBean entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(SocialBean entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(SocialBean entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(SocialBean entity) {
