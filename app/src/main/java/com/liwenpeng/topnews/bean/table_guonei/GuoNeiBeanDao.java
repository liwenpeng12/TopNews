...
/** 
 * DAO for table "GUO_NEI_BEAN".
*/
public class GuoNeiBeanDao extends AbstractDao<GuoNeiBean, Long> {

    public static final String TABLENAME = "GUO_NEI_BEAN";

    /**
     * Properties of entity GuoNeiBean.<br/>
    ...
    public GuoNeiBeanDao(DaoConfig config) {
        super(config);
    }
    
    public GuoNeiBeanDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"GUO_NEI_BEAN\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"GUO_NEI_BEAN\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, GuoNeiBean entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, GuoNeiBean entity) {
        stmt.clearBindings();
    ...
    @Override
    public GuoNeiBean readEntity(Cursor cursor, int offset) {
        GuoNeiBean entity = new GuoNeiBean( //
    ...
    @Override
    public void readEntity(Cursor cursor, GuoNeiBean entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(GuoNeiBean entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(GuoNeiBean entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(GuoNeiBean entity) {
