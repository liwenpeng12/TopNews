package com.liwenpeng.topnews.bean.table_yule;
...
public class YuleBean {
    ...
    @Generated(hash = 1800852983)
    public YuleBean(Long id, String title, String date, String category,
