package com.liwenpeng.topnews.bean.table_guonei;
...
public class GuoNeiBean {
    ...
    @Generated(hash = 558240790)
    public GuoNeiBean(Long id, String title, String date, String category,
