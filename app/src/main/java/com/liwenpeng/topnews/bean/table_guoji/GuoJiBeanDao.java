...
/** 
 * DAO for table "GUO_JI_BEAN".
*/
public class GuoJiBeanDao extends AbstractDao<GuoJiBean, Long> {

    public static final String TABLENAME = "GUO_JI_BEAN";

    /**
     * Properties of entity GuoJiBean.<br/>
    ...
    public GuoJiBeanDao(DaoConfig config) {
        super(config);
    }
    
    public GuoJiBeanDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"GUO_JI_BEAN\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"GUO_JI_BEAN\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, GuoJiBean entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, GuoJiBean entity) {
        stmt.clearBindings();
    ...
    @Override
    public GuoJiBean readEntity(Cursor cursor, int offset) {
        GuoJiBean entity = new GuoJiBean( //
    ...
    @Override
    public void readEntity(Cursor cursor, GuoJiBean entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(GuoJiBean entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(GuoJiBean entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(GuoJiBean entity) {
