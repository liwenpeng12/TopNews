package com.liwenpeng.topnews.bean.table_keji;
...
public class KeJiBean {
    ...
    @Generated(hash = 442277036)
    public KeJiBean(Long id, String title, String date, String category,
