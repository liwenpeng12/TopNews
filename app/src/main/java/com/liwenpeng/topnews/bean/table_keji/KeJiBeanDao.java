...
/** 
 * DAO for table "KE_JI_BEAN".
*/
public class KeJiBeanDao extends AbstractDao<KeJiBean, Long> {

    public static final String TABLENAME = "KE_JI_BEAN";

    /**
     * Properties of entity KeJiBean.<br/>
    ...
    public KeJiBeanDao(DaoConfig config) {
        super(config);
    }
    
    public KeJiBeanDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"KE_JI_BEAN\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"KE_JI_BEAN\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, KeJiBean entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, KeJiBean entity) {
        stmt.clearBindings();
    ...
    @Override
    public KeJiBean readEntity(Cursor cursor, int offset) {
        KeJiBean entity = new KeJiBean( //
    ...
    @Override
    public void readEntity(Cursor cursor, KeJiBean entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(KeJiBean entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(KeJiBean entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(KeJiBean entity) {
