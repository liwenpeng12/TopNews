...
/** 
 * DAO for table "JUN_SHI_BEAN".
*/
public class JunShiBeanDao extends AbstractDao<JunShiBean, Long> {

    public static final String TABLENAME = "JUN_SHI_BEAN";

    /**
     * Properties of entity JunShiBean.<br/>
    ...
    public JunShiBeanDao(DaoConfig config) {
        super(config);
    }
    
    public JunShiBeanDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"JUN_SHI_BEAN\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"JUN_SHI_BEAN\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, JunShiBean entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, JunShiBean entity) {
        stmt.clearBindings();
    ...
    @Override
    public JunShiBean readEntity(Cursor cursor, int offset) {
        JunShiBean entity = new JunShiBean( //
    ...
    @Override
    public void readEntity(Cursor cursor, JunShiBean entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(JunShiBean entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(JunShiBean entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(JunShiBean entity) {
