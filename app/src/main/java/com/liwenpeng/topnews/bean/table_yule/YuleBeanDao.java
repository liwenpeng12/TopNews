...
/** 
 * DAO for table "YULE_BEAN".
*/
public class YuleBeanDao extends AbstractDao<YuleBean, Long> {

    public static final String TABLENAME = "YULE_BEAN";

    /**
     * Properties of entity YuleBean.<br/>
    ...
    public YuleBeanDao(DaoConfig config) {
        super(config);
    }
    
    public YuleBeanDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"YULE_BEAN\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"YULE_BEAN\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, YuleBean entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, YuleBean entity) {
        stmt.clearBindings();
    ...
    @Override
    public YuleBean readEntity(Cursor cursor, int offset) {
        YuleBean entity = new YuleBean( //
    ...
    @Override
    public void readEntity(Cursor cursor, YuleBean entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(YuleBean entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(YuleBean entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(YuleBean entity) {
