...
/** 
 * DAO for table "GDBEAN".
*/
public class GDBeanDao extends AbstractDao<GDBean, Long> {

    public static final String TABLENAME = "GDBEAN";

    /**
     * Properties of entity GDBean.<br/>
    ...
    public GDBeanDao(DaoConfig config) {
        super(config);
    }
    
    public GDBeanDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"GDBEAN\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"GDBEAN\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, GDBean entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, GDBean entity) {
        stmt.clearBindings();
    ...
    @Override
    public GDBean readEntity(Cursor cursor, int offset) {
        GDBean entity = new GDBean( //
    ...
    @Override
    public void readEntity(Cursor cursor, GDBean entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(GDBean entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(GDBean entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(GDBean entity) {
