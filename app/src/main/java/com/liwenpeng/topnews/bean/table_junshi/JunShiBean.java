package com.liwenpeng.topnews.bean.table_junshi;
...
public class JunShiBean {
    ...
    @Generated(hash = 1613108860)
    public JunShiBean(Long id, String title, String date, String category,
