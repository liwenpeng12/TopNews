...
/** 
 * DAO for table "SHI_SHANG_BEAN".
*/
public class ShiShangBeanDao extends AbstractDao<ShiShangBean, Long> {

    public static final String TABLENAME = "SHI_SHANG_BEAN";

    /**
     * Properties of entity ShiShangBean.<br/>
    ...
    public ShiShangBeanDao(DaoConfig config) {
        super(config);
    }
    
    public ShiShangBeanDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"SHI_SHANG_BEAN\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"SHI_SHANG_BEAN\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, ShiShangBean entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, ShiShangBean entity) {
        stmt.clearBindings();
    ...
    @Override
    public ShiShangBean readEntity(Cursor cursor, int offset) {
        ShiShangBean entity = new ShiShangBean( //
    ...
    @Override
    public void readEntity(Cursor cursor, ShiShangBean entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(ShiShangBean entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(ShiShangBean entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(ShiShangBean entity) {
